...
public class JsonAdaptedPersonTest {
    ...
    public void toModelType_nonEmptyRemark_returnsPersonWithRemark() throws Exception {
        var personWithRemark = new PersonBuilder(BENSON).withRemark("Likes to swim.").build();
        JsonAdaptedPerson adaptedPerson = new JsonAdaptedPerson(personWithRemark);

        assertEquals(personWithRemark.getRemark(), adaptedPerson.toModelType().getRemark());
    }
